        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-4">
            <Link href="/" className="flex items-center gap-3 group mb-5">
              <svg width="24" height="24" viewBox="0 0 28 28" fill="none" className="text-accent transition-transform duration-300 group-hover:rotate-45">
                <circle cx="14" cy="14" r="5" stroke="currentColor" strokeWidth="1.5" />
                <line x1="14" y1="0" x2="14" y2="7" stroke="currentColor" strokeWidth="1.5" />
                <line x1="14" y1="21" x2="14" y2="28" stroke="currentColor" strokeWidth="1.5" />
                <line x1="0" y1="14" x2="7" y2="14" stroke="currentColor" strokeWidth="1.5" />
                <line x1="21" y1="14" x2="28" y2="14" stroke="currentColor" strokeWidth="1.5" />
              </svg>
            ...
            <div className="flex items-center gap-3 mt-6">
              ...
              <a
                href="https://linkedin.com/in/yussef-makhlouf"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center border border-navy/8 dark:border-off-white/8 text-muted hover:text-accent hover:border-accent/30 transition-all"
                aria-label="LinkedIn"
